...
const Notes = () => {
    ...
    return (
        <>
            <Form form={form} name="horizontal_login" layout="inline" onFinish={onFinish} style={{'display':"flex","justifyContent":"space-between"}}>
                <Form.Item
                    name="search"
                >
                    <Input prefix={<SearchOutlined className="site-form-item-icon" />} placeholder="Search here..." />
                </Form.Item>
